...
module.exports = function i18nYmlLoader(source, map) {
    ...
    //source, reqPlatform, idsOnly, defLocale, skipPlatforms
    const reqPlatform = ('reqPlatform' in options ? options.reqPlatform : loader.reqPlatform) || false; /* ?*/
    ...
    let result;
    try {
        result = JSON.stringify(processor(yamlFile, reqPlatform, idsOnly, defLocale, skipPlatform), null, '\t'); /* ?*/
    } catch (ex) {
